...
import icon5 from '../assets/images/nav_5-blue.png'
...
const detailManage = resolve => require(['@/pages/assetManager/detailManage.vue'], resolve)
...
const routes = [
  {
    ...
    children: [
      // 资产管理员
      { path: '/assetManager/assetList', component: assetList, name: '资产管理', meta: { num: 0, icon: icon1 } },
      ...
      { path: '/assetManager/detailManage', component: detailManage, name: '领用详情管理', meta: { num: 3, icon: icon5 } },
      // 普通教师
      { path: '/commonTeacher/receiveDetail', component: receiveDetail, name: '我的操作记录', meta: { num: 4, icon: icon4 } }
    ]
  },
