        ...
        <div class="question">
            <div v-for="(item, index) in allList" :key="index">
              ...
              <div class="answer-question" v-if="item.questionType === 2">
                <p class="title-input" v-if="item.show">请输入标题:</p>
                ...
                <el-input v-model.trim="item.title" v-if="item.show" v-focus="true" type="textarea" :maxlength="200"></el-input>
                <p v-if="item.show">
              ...
              <!-- 段落说明 -->
              <div class="answer-question" v-if="item.questionType === 3" style="cursor: pointer;">
                <p class="title-input" v-if="item.show">请输入标题：</p>
                <div @click="editShow(item)" class="answer-question-look" v-if="!item.show">
                  <p>{{item.title}}</p>
                </div>
                <el-input v-model.trim="item.title" v-if="item.show" v-focus="true" type="textarea" :maxlength="200"></el-input>
                <p v-if="item.show">
            ...
            <div class="answer-question" v-if="objectiveShow">
              <p class="title-input">请输入标题:</p>
              <el-input v-model.trim="objectiveContent" v-focus="true" type="textarea" :maxlength="200"></el-input>
              <p>
            ...
            <div class="choose-question" v-if="subjectiveShow">
              ...
              <p>
                <span>题目</span><el-input v-model.trim="subjectiveContent" v-focus="true" :maxlength="150"></el-input>
              </p>
    
              <transition-group name="slide-left" mode="out-in"> 
                <div v-for="(item, index) in options" :key="index">
                  <span>选项</span>
                  <el-input v-model.trim="item.optionContent" :maxlength="100"></el-input>
                  <i>分数</i>
                  <el-input class="score" v-model.number="item.score" :min="0" type="number"></el-input>
                  <sub>
