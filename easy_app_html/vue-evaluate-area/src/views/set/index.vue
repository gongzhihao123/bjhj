        ...
        <el-row class="choose-admin">
          ...
          <el-col :span="19">
            <el-form-item prop="selectedManager" class="has-selected-manager">
              <span class="choose" @click="managerOpen" v-if="!ruleForm.selectedManager">选择管理员</span>
        ...
        <el-row class="note">
          ...
          <el-col :span="19">
            <el-form-item prop="noteContent">
              <el-input type="textarea" :maxlength="120" :rows="3" v-model.trim="ruleForm.noteContent" placeholder="填写备注"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
