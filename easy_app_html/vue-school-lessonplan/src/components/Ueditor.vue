...
<script>
  ...
  import '../../static/utf8-jsp/kityformula-plugin/addKityFormulaDialog.js'
  import '../../static/utf8-jsp/kityformula-plugin/defaultFilterFix.js'
  import '../../static/utf8-jsp/kityformula-plugin/getKfContent.js'
  ...
  export default {
    ...
    methods: {
      ...
      ueditorContent () {
        this.instance = UE.getEditor(this.randomId).getContent()
