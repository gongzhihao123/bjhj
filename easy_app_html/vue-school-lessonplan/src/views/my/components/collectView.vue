<template>
  <div id="collectView-view">
    <!--顶部导航-->
    <header>
      <p>我的&nbsp;> &nbsp;我的收藏&nbsp;>&nbsp;{{all.sectionName}}&nbsp;>&nbsp;{{all.gradeName}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发表时间：{{all.createdTime | dateFormat('yyyy-MM-dd hh:mm:ss')}}
        <span @click="goBack">
          返回上一层
        </span>
      </p>
    ...
    <main>
      <div class="title">
        ...
        <p>
          ...
          <el-rate v-model="all.score" disabled></el-rate>
...
export default {
  ...
  methods: {
    ...
    reuse () {
      ...
      sessionStorage.path = '/my/collectView'
    },
    goBack () {
      this.$router.push({path: '/my/collect', query: {pageNo: this.$route.query.pageNo}})
    },
    // 下载
    download () {
      if (this.content) {
