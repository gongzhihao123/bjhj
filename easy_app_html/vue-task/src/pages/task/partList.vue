<template>
  <div class='part-list'>
    ...
    <header>
      ...
      <el-button size="small" type="success" @click="participateList" icon="el-icon-search">搜索</el-button>
    </header>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <i v-if="scope.row.feedbackFlag" style="color: #74BC43;">
              我已完成
            </i>
            <i v-else style="color: #F0270A;">
              我未完成
            </i>
          </template>
        </el-table-column>
