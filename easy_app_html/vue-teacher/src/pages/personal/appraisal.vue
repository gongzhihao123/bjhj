    ...
    <el-dialog
      ...
      <div class="content">
        <el-form :model="addPlanForm" ref="addPlanForm" label-width="100px" :rules="addPlanRules">
          ...
          <el-form-item label="颁发荣誉单位" prop="yearReview">
            <div class="textPlann">
              <el-input  :maxlength="20" size="small" placeholder="请输入颁发荣誉单位" v-model="addPlanForm.yearReview"></el-input>
            </div>
          </el-form-item>
          <el-form-item label="师德考核结果" prop="review">
            <div class="textPlann">
              <el-input  :maxlength="20" size="small" placeholder="请输入师德考核结果" v-model="addPlanForm.review"></el-input>
            </div>
          </el-form-item>
          <el-form-item label="考核类型" prop="checkType">
            <div class="textPlann">
              <el-input  :maxlength="20" size="small" placeholder="请输入考核类型" v-model="addPlanForm.checkType"></el-input>
            </div>
          </el-form-item>
          <el-form-item label="备注" prop="remarks">
            <div class="textPlann">
              <el-input  :maxlength="20" size="small"  type="textarea"  placeholder="请输入备注" v-model="addPlanForm.remarks"></el-input>
            </div>
          </el-form-item>
        </el-form>
...
export default {
  ...
  data () {
    return {
      ...
      addPlanRules: {
        yearReview: [
          { required: true, message: '请输入年度考评结果', trigger: 'blur' }
        ],
        checkType: [
          { required: true, message: '请输入考核类型', trigger: 'blur' }
        ],
        yearDateStart: [
          { required: true, message: '请选择年度考评起始时间', trigger: 'blur' }
        ],
        yearDateEnd: [
          { required: true, message: '请选择年度考评终止时间', trigger: 'blur' }
        ],
        review: [
          { required: true, message: '请输入师德考核结果', trigger: 'blur' }
        ]
      },
      pageSize: 10,
      totalPage: 11,
