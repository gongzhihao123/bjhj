    ...
    <el-dialog
      ...
      <div class="content">
        <el-form :model="addPlanForm" ref="addPlanForm" label-width="100px" :rules="addPlanRules">
          ...
          <el-form-item label="挂职单位" prop="yearReview">
            <div class="textPlann">
              <el-input  :maxlength="20" size="small" placeholder="请输入挂职单位" v-model="addPlanForm.yearReview"></el-input>
            </div>
          </el-form-item>
          <el-form-item label="岗位及职务" prop="review"  label-height='20px'>
            <div class="textPlann">
              <el-input  :maxlength="20" size="small" placeholder="请输入岗位及职务" v-model="addPlanForm.review"></el-input>
            </div>
          </el-form-item>
          <el-form-item label="挂职鉴定" prop="checkType">
            <div class="textPlann">
              <el-input  :maxlength="20" size="small" placeholder="请输入挂职鉴定" v-model="addPlanForm.checkType"></el-input>
            </div>
          </el-form-item>
...
export default {
  ...
  data () {
    return {
      ...
      addPlanRules: {
        yearReview: [
          { required: true, message: '请输入挂职单位', trigger: 'blur' }
        ],
        checkType: [
          { required: true, message: '请输入挂职鉴定', trigger: 'blur' }
        ],
        yearDateStart: [
        ...
        review: [
          { required: true, message: '请输入岗位及职务', trigger: 'blur' }
        ]
      },
      pageSize: 10,
      totalPage: 11,
